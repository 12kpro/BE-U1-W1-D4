...
import es_1.Dipendente.Dipartimento;
import es_1.Dipendente.Livello;
...
public class GestioneDipendenti {
	...
	public static void main(String[] args) {
		...
		dipendenti[2] = new Dipendente((double) 1200, "ABC-345", (double) 1250,(double) 15, Livello.IMPIEGATO, Dipartimento.AMMINITRAZIONE);
		dipendenti[3] = new Dipendente((double) 2000, "ABC-456", (double) 2250,(double) 25, Livello.DIRIGENTE, Dipartimento.VENDITE);

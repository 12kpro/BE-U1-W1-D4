...
public class Dipendente {
	...
	public void stampaDatiDipendente(){
		System.out.printf("Matricola: %s - StipendioBase:  %f - Stipendio: %f - ImportoOrarioStraordinario: %f - Livello: %s - Dipartimento: %s%n", matricola, stipendioBase, stipendio,importoOrarioStraordinario,livello,dipartimento);
	}
